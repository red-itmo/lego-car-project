...
from TrajectoryStuff import Point, Pose, ClothoidLine, StraightLine, CircleLine


# Class for encoding the trajectory
class TrajectoryParser:

    # Constructor gets initial pose of a robot as an argument
    # pose = [ x, y, angle ]
    ...
    # Method transform point in robot's system of coordinates
    # TODO: It might be that the problem in here
    ...
    # Method transform point in robot's system of coordinates
    # TODO: It might be that the problem in here (with angle)
    ...
    # Main function gets trajectory descriptor and returns transformed version of it
